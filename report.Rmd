...
table_data <- readRDS(here::here("output/tables/",summary_filename))
...
box_plot <- readRDS(here::here("output/figures/",boxplot_filename))
...
table_data <- readRDS(here::here("output/tables/",top_filename))
...
scatter_filename <- paste0("nba_player_", config$default_player, ".rds")

scatter_plot <- readRDS(here::here("output/figures/",scatter_filename))
